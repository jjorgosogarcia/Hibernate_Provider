       ...
       // view = request.getParameter("view");
        ...
        if(target.equals("inmueble") && op.equals("select") && action.equals("view") /*|| view ==null*/){
          ...
          ArrayList<Fotos> lista = fotos(id);
            ...
            /*Móvil*/
         }  else if (target.equals("inmueble") && op.equals("insert") && action.equals("opandroid")) {
            forward = true;
            Inmueble inm = new Inmueble();
            ...
            inm.setPrecio(BigDecimal.valueOf(Double.parseDouble(request.getParameter("precio"))));
